    ...
    "56d7": function (e, o, n) {
      ...
      const i = Object(t["d"])(
        ...
        function r(e, o, n, r, d, l) {
            const imgSrc = () => {
                if (r.voice.voiceMode === 0) {
                  return r.voice.talking ? "../images/microphone_whisper_2.png" : "../images/microphone_whisper.png";
                } else if (r.voice.voiceMode === 1) {
                  return r.voice.talking ? "../images/microphone_normal_2.png" : "../images/microphone_normal.png";
                } else if (r.voice.voiceMode === 2) {
                  return r.voice.talking ? "../images/microphone_shouting_2.png" : "../images/microphone_shouting.png";
                } else {
                  return "";
                }
              };
            ...
            return (
              ...
              Object(t["c"])("body", null, [
                ...
                r.voice.uiEnabled
                  ? (Object(t["f"])(),
                    Object(t["c"])("div", a, [
                      0 !== r.voice.callInfo || r.voice.voiceModes.length
                        ? (Object(t["f"])(),
                          Object(t["c"])("img", {
                            key: 0,
